...
public class Main {
    public static void main(String[] args) {
        ...
        // 1.3
        int c = sum(2_147_483_647, 1);
        assert c == -2147483648 : "sum(2_147_483_647, 1) should return -2147483648";
        System.out.println("sum(2_147_483_647, 1) should return -2147483648");
    }
    ...
    public static int sum(int a, int b) {
        ...
        assert (result <= Integer.MAX_VALUE && result >= Integer.MIN_VALUE);
        return a + b;
    }
    ...
    public static void checkingHero() {
        ...
        */
        ...
        assert 50 == emmett.getArmorStrength() : "Hero armor strength should be 50";
        assert "sword".equals(emmett.getWeapon()) : "Weapon should be sword";
        assert 3 == emmett.getBag().size() : "Bag should contain 3 items";
        assert emmett.getBag().contains("Bow") : "Bag should contain Bow";
        assert emmett.getBag().contains("Axe") : "Bag should contain Axe";
        assert emmett.getBag().contains("Gold") : "Bag should contain Gold";
